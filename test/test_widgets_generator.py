...
class WidgetTestGenerator(unittest.TestCase):
    ...
    def test_random(self):
        ...
        fileout = 'test/test_sets/tmp/random.adjm'
        expected = 'test/test_sets/output/generate/random/generated.adjm'
    ...
    def test_scalefree(self):
        ...
        the_exception = cm.exception
        self.assertEqual(the_exception.code, 0)
        fileout = 'test/test_sets/tmp/scalefree.adjm'
        expected = 'test/test_sets/output/generate/scalefree/generated.adjm'
    ...
    def test_tree(self):
        ...
        the_exception = cm.exception
        self.assertEqual(the_exception.code, 0)
        fileout = 'test/test_sets/tmp/tree.adjm'
        expected = 'test/test_sets/output/generate/tree/generated.adjm'
    ...
    def test_smallworld(self):
        ...
        the_exception = cm.exception
        self.assertEqual(the_exception.code, 0)
        fileout = 'test/test_sets/tmp/smallworld.adjm'

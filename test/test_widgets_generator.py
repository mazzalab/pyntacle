...
class WidgetTestGenerator(unittest.TestCase):
    ...
    def test_random(self):
        ...
        fileout = os.path.join(current_dir, 'test/test_sets/tmp/random.adjm')
        expected = os.path.join(current_dir, 'test/test_sets/output/generate/random/generated.adjm')
    ...
    def test_scalefree(self):
        ...
        the_exception = cm.exception
        self.assertEqual(the_exception.code, 0)
        fileout = os.path.join(current_dir, 'test/test_sets/tmp/scalefree.adjm')
        expected = os.path.join(current_dir, 'test/test_sets/output/generate/scalefree/generated.adjm')
    ...
    def test_tree(self):
        ...
        the_exception = cm.exception
        self.assertEqual(the_exception.code, 0)
        fileout = os.path.join(current_dir, 'test/test_sets/tmp/tree.adjm')
        expected = os.path.join(current_dir, 'test/test_sets/output/generate/tree/generated.adjm')
    ...
    def test_smallworld(self):
        ...
        the_exception = cm.exception
        self.assertEqual(the_exception.code, 0)
        fileout = os.path.join(current_dir, 'test/test_sets/tmp/smallworld.adjm')
        expected = os.path.join(current_dir, 'test/test_sets/output/generate/smallworld/generated.adjm')
        self.assertEqual(getmd5(fileout), getmd5(expected),

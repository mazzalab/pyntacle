...
class Generate:
    ...
    def run(self):
        ...
        if out_form == "adjm":
            ...
            sys.stdout.write(u"Storing the created graph into a binary file (ending in .graph)...\n")

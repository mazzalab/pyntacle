...
class KPWrapper:
    ...
    @timeit
    def run_KPPos(self, nodes, kpp_type:KpposEnum, m=None, max_distances=None, implementation=CmodeEnum.igraph):
        """
    ...
    @timeit
    def run_KPNeg(self, nodes, kpp_type:KpnegEnum, max_distances=None, implementation = CmodeEnum.igraph):
        """
...
class GOWrapper:
    ...
    @timeit
    def run_fragmentation(self, kpp_size:int, kpp_type:KpnegEnum, max_distances=None, seed=None, implementation=CmodeEnum.igraph):
        """
    ...
    @timeit
    def run_reachability(self, kpp_size:int, kpp_type:KpposEnum, m=None, max_distances=None, seed=None, implementation=CmodeEnum.igraph):
        """
...
class BFWrapper:
    ...
    @timeit
    def run_fragmentation(self, kpp_size:int, kpp_type:KpnegEnum, max_distances=None, implementation=CmodeEnum.igraph):
        """
    ...
    @timeit
    def run_reachability(self, kpp_size: int, kpp_type: KpposEnum, m=None, max_distances=None, implementation=CmodeEnum.igraph):
        """

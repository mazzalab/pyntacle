...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "/home/mik/work/pyntacle/pyntacle/_ext/kp_metrics.pyx"
        ]
    },
...
static int (*__pyx_f_4_ext_13cython_igraph_igraph_dijkstra)(__Pyx_memviewslice, double *, int *, int); /*proto*/
static int (*__pyx_f_4_ext_13cython_igraph_igraph_components)(__Pyx_memviewslice, long *, int *, int); /*proto*/

/* Module declarations from "_ext.kp_metrics" */
static double __pyx_v_4_ext_10kp_metrics_INF;
...
static double __pyx_f_4_ext_10kp_metrics_m_reach(double *__pyx_v_all_dist, int *__pyx_v_K_indices, int *__pyx_v_notK_indices, int __pyx_v_k, int __pyx_v_n, int __pyx_v_mdist) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k_node;
  int __pyx_v_notK_node;
  double __pyx_v_mReach;
  int *__pyx_v_visited;
  double __pyx_r;
  int __pyx_t_1;
  int __pyx_t_2;
 ...
 * 
*/
  __pyx_v_visited = ((int *)malloc((__pyx_v_n * (sizeof(int)))));

  /* "_ext/kp_metrics.pyx":17
 *     cdef double mReach = 0.
 *     cdef bint* visited = <bint*> malloc(n * sizeof(bint))
 *     memset(visited, 0, n * sizeof(bint))             # <<<<<<<<<<<<<<
 * 
 *     for j from 0 <= j < k:
*/
  (void)(memset(__pyx_v_visited, 0, (__pyx_v_n * (sizeof(int)))));

  /* "_ext/kp_metrics.pyx":19
 *     memset(visited, 0, n * sizeof(bint))
 * 
 *     for j from 0 <= j < k:             # <<<<<<<<<<<<<<
 *         k_node = K_indices[j]
 ...
 *                 mReach += 1
*/
      __pyx_t_4 = ((__pyx_v_all_dist[((__pyx_v_notK_node * __pyx_v_n) + __pyx_v_k_node)]) <= __pyx_v_mdist);
      if (__pyx_t_4) {
      } else {
        __pyx_t_3 = __pyx_t_4;
        goto __pyx_L8_bool_binop_done;
      }
      __pyx_t_4 = (!(__pyx_v_visited[__pyx_v_i]));
      __pyx_t_3 = __pyx_t_4;
 ...
 *     return mReach
*/
  free(__pyx_v_visited);

  /* "_ext/kp_metrics.pyx":32
 *     free(visited)
 * 
 *     return mReach             # <<<<<<<<<<<<<<
 * 
...
static double __pyx_f_4_ext_10kp_metrics_get_distance_weighted_reach(double *__pyx_v_all_dist, int *__pyx_v_K_indices, int *__pyx_v_notK_indices, int __pyx_v_k, int __pyx_v_n) {
  ...
  int __pyx_v_notK_node;
  double __pyx_v_dR;
  double __pyx_v_min_sp;
  double __pyx_r;
  int __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;

  /* "_ext/kp_metrics.pyx":38
 *     cdef int i, j
 *     cdef int k_node, notK_node
 *     cdef double dR = 0             # <<<<<<<<<<<<<<
 *     cdef double min_sp
 ...
 *         for j from 0 <= j < k:
*/
    __pyx_v_min_sp = __pyx_v_4_ext_10kp_metrics_INF;
 ...
 *     return dR
*/
  __pyx_v_dR = (__pyx_v_dR / ((double)(__pyx_v_n - __pyx_v_k)));
...
static double __pyx_f_4_ext_10kp_metrics_get_fragmentation(__Pyx_memviewslice __pyx_v_adj_matrix, int *__pyx_v_K_indices, int __pyx_v_k) {
  int __pyx_v_n;
  int __pyx_v_i;
  int __pyx_v_comp_num;
  double __pyx_v_component_f;
  int __pyx_v_component_num;
  double __pyx_v_f;
  long *__pyx_v_size_comp;
  double __pyx_r;
  int __pyx_t_1;
  int __pyx_t_2;
 ...
 * 
*/
  __pyx_v_component_num = 0;

  /* "_ext/kp_metrics.pyx":75
 *     cdef double f
 * 
...
*/
  __pyx_v_size_comp = ((long *)malloc((__pyx_v_n * (sizeof(long)))));
...
*/
  __pyx_v_comp_num = __pyx_f_4_ext_13cython_igraph_igraph_components(__pyx_v_adj_matrix, __pyx_v_size_comp, __pyx_v_K_indices, __pyx_v_k);
...
*/
    __pyx_v_component_f = (__pyx_v_component_f + ((__pyx_v_size_comp[__pyx_v_i]) * ((__pyx_v_size_comp[__pyx_v_i]) - 1)));
  }
 ...
 *     else:
*/
  __pyx_t_2 = (__pyx_v_component_num == 1);
  if (__pyx_t_2) {
...
*/
  /*else*/ {
    __pyx_v_f = (1. - (__pyx_v_component_f / ((double)((__pyx_v_n - __pyx_v_k) * ((__pyx_v_n - __pyx_v_k) - 1)))));
  }
  __pyx_L5:;
...
static double __pyx_f_4_ext_10kp_metrics_get_distance_fragmentation(__Pyx_memviewslice __pyx_v_adj, int *__pyx_v_K_indices, int __pyx_v_k) {
  int __pyx_v_n;
  int __pyx_v_i;
  int __pyx_v_j;
  double __pyx_v_dF;
  double __pyx_v_df_denum;
  double __pyx_v_df_num;
  double __pyx_v_sum_sp;
  double *__pyx_v_shortest_path_lengths;
  double __pyx_r;
  int __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;

  /* "_ext/kp_metrics.pyx":92
 * cdef double get_distance_fragmentation(double[:, :] adj, int* K_indices, int k) noexcept nogil:
 * 
 *     cdef int n = adj.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int i, j
...
*/
  __pyx_v_shortest_path_lengths = ((double *)malloc(((__pyx_v_n * __pyx_v_n) * (sizeof(double)))));
 ...
 * 
*/
  __pyx_t_1 = (__pyx_f_4_ext_13cython_igraph_igraph_dijkstra(__pyx_v_adj, __pyx_v_shortest_path_lengths, __pyx_v_K_indices, __pyx_v_k) != 0);
  if (__pyx_t_1) {

    /* "_ext/kp_metrics.pyx":102
 * 
 *     if cython_igraph.igraph_dijkstra(adj, shortest_path_lengths, K_indices, k) != 0:
 *         printf("Failed to compute shortest path matrix!\n")             # <<<<<<<<<<<<<<
 * 
 *     df_num = 0
*/
    (void)(printf(((char const *)"Failed to compute shortest path matrix!\n")));
 ...
 *         df_num += sum_sp
*/
      __pyx_v_sum_sp = (__pyx_v_sum_sp + (1. / (__pyx_v_shortest_path_lengths[((__pyx_v_i * __pyx_v_n) + __pyx_v_j)])));
    }

    /* "_ext/kp_metrics.pyx":114
 *             sum_sp += (1. / shortest_path_lengths[i*n + j])
 * 
 *         df_num += sum_sp             # <<<<<<<<<<<<<<
 * 
...
*/
    __pyx_v_df_num = (__pyx_v_df_num + __pyx_v_sum_sp);
  }
 ...
 *     df_num *= 2
*/
  free(__pyx_v_shortest_path_lengths);
...
*/
  __pyx_v_df_denum = ((__pyx_v_n - __pyx_v_k) * ((__pyx_v_n - __pyx_v_k) - 1));
 ...
 *     return dF
*/
  __pyx_v_dF = (1.0 - (__pyx_v_df_num / __pyx_v_df_denum));
...
static int __Pyx_modinit_function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (__Pyx_ExportFunction("get_fragmentation", (void (*)(void))__pyx_f_4_ext_10kp_metrics_get_fragmentation, "double (__Pyx_memviewslice, int *, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("get_distance_fragmentation", (void (*)(void))__pyx_f_4_ext_10kp_metrics_get_distance_fragmentation, "double (__Pyx_memviewslice, int *, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("get_distance_weighted_reach", (void (*)(void))__pyx_f_4_ext_10kp_metrics_get_distance_weighted_reach, "double (double *, int *, int *, int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("m_reach", (void (*)(void))__pyx_f_4_ext_10kp_metrics_m_reach, "double (double *, int *, int *, int, int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_function_import_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  __pyx_t_1 = PyImport_ImportModule("_ext.cython_igraph"); if (!__pyx_t_1) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "igraph_dijkstra", (void (**)(void))&__pyx_f_4_ext_13cython_igraph_igraph_dijkstra, "int (__Pyx_memviewslice, double *, int *, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction_3_1_5(__pyx_t_1, "igraph_components", (void (**)(void))&__pyx_f_4_ext_13cython_igraph_igraph_components, "int (__Pyx_memviewslice, long *, int *, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
static int __pyx_pymod_exec_kp_metrics(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_kp_metrics},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_kp_metrics(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_kp_metrics(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_kp_metrics(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'kp_metrics' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "kp_metrics" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_kp_metrics", 0);
 ...
 * cdef double m_reach(double* all_dist, int* K_indices, int* notK_indices, int k, int n, int mdist) noexcept nogil:
*/
  __pyx_v_4_ext_10kp_metrics_INF = 1e9;

...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/home/mik/miniconda3/envs/pyntacle_igraph/include/igraph/igraph.h"
        ],
        "extra_compile_args": [
            "-fopenmp"
        ],
        ...
        "include_dirs": [
            "/home/mik/miniconda3/envs/pyntacle_igraph/include"
        ],
        "libraries": [
            "igraph"
        ],
        "library_dirs": [
            "/home/mik/miniconda3/envs/pyntacle_igraph/lib"
        ],
        ...
        "sources": [
            "/home/mik/work/pyntacle/pyntacle/_ext/cython_igraph.pyx"
        ]
    },
...
static int __pyx_f_4_ext_13cython_igraph_igraph_dijkstra(__Pyx_memviewslice __pyx_v_adj_matrix, double *__pyx_v_distances, int *__pyx_v_k_set, int __pyx_v_k) {
  int __pyx_v_i;
  int __pyx_v_j;
  igraph_t __pyx_v_graph;
  igraph_vector_t __pyx_v_weights;
  igraph_matrix_t __pyx_v_ig_adj_matrix;
  igraph_int_t __pyx_v_ig_n;
  igraph_error_t __pyx_v_result;
  int __pyx_r;
  int __pyx_t_1;
  igraph_int_t __pyx_t_2;
  igraph_int_t __pyx_t_3;
  Py_ssize_t __pyx_t_4;
  Py_ssize_t __pyx_t_5;
  int __pyx_t_6;
 ...
 * 
*/
    (void)(printf(((char const *)"Failed to initialize igraph_matrix_t: %d !"), __pyx_v_result));

    /* "_ext/cython_igraph.pyx":82
 *     if result != 0: # IGRAPH_SUCCESS is usually 0
 *         printf("Failed to initialize igraph_matrix_t: %d !", result)
 *         return 1             # <<<<<<<<<<<<<<
 * 
...
*/
      __pyx_t_4 = __pyx_v_i;
      __pyx_t_5 = __pyx_v_j;
      igraph_matrix_set((&__pyx_v_ig_adj_matrix), __pyx_v_i, __pyx_v_j, (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_adj_matrix.data + __pyx_t_4 * __pyx_v_adj_matrix.strides[0]) ) + __pyx_t_5 * __pyx_v_adj_matrix.strides[1]) ))));
    }
  }

  /* "_ext/cython_igraph.pyx":88
 *             igraph_matrix_set(&ig_adj_matrix, i, j, adj_matrix[i, j])
 * 
 *     if k_set != NULL:             # <<<<<<<<<<<<<<
...
*/
        igraph_matrix_set((&__pyx_v_ig_adj_matrix), __pyx_v_j, (__pyx_v_k_set[__pyx_v_i]), 0.);
      }
    }
 ...
 *         return 1
*/
    (void)(printf(((char const *)"Failed to initialize igraph_vector_t for weights!")));
 ...
 *         igraph_matrix_destroy(&ig_adj_matrix)
*/
    (void)(printf(((char const *)"Failed to create weighted adjacency matrix!")));
 ...
 *         igraph_vector_destroy(&weights)
*/
  __pyx_t_1 = (igraph_distances_dijkstra((&__pyx_v_graph), (&__pyx_v_ig_adj_matrix), igraph_vss_all(), igraph_vss_all(), (&__pyx_v_weights), IGRAPH_ALL) != 0);
  if (__pyx_t_1) {
 ...
 *         igraph_matrix_destroy(&ig_adj_matrix)
*/
    (void)(printf(((char const *)"Failed to compute distances using Dijkstra's algorithm!")));

    /* "_ext/cython_igraph.pyx":113
 *     if igraph_distances_dijkstra(&graph, &ig_adj_matrix, igraph_vss_all(), igraph_vss_all(), &weights, IGRAPH_ALL) != 0:
 *         printf("Failed to compute distances using Dijkstra's algorithm!")
 *         igraph_vector_destroy(&weights)             # <<<<<<<<<<<<<<
 *         igraph_matrix_destroy(&ig_adj_matrix)
...
*/
  igraph_matrix_copy_to((&__pyx_v_ig_adj_matrix), __pyx_v_distances, IGRAPH_ROW_MAJOR);
...
static int __pyx_f_4_ext_13cython_igraph_igraph_components(__Pyx_memviewslice __pyx_v_adj_matrix, long *__pyx_v_size_comp, int *__pyx_v_k_set, int __pyx_v_k) {
  int __pyx_v_i;
  int __pyx_v_j;
  igraph_int_t __pyx_v_comp_size;
  igraph_t __pyx_v_graph;
  igraph_vector_t __pyx_v_weights;
  igraph_matrix_t __pyx_v_ig_adj_matrix;
  igraph_vector_int_t __pyx_v_csize;
  igraph_int_t __pyx_v_ig_n;
  igraph_error_t __pyx_v_result;
  int __pyx_r;
  int __pyx_t_1;
 ...
 *         igraph_matrix_destroy(&ig_adj_matrix)
*/
    (void)(printf(((char const *)"Failed to initialize csize vector!")));

    /* "_ext/cython_igraph.pyx":176
 *     if igraph_vector_int_init(&csize, 0) != 0:
 *         printf("Failed to initialize csize vector!")
 *         igraph_vector_destroy(&weights)             # <<<<<<<<<<<<<<
 *         igraph_matrix_destroy(&ig_adj_matrix)
...
*/
    (void)(printf(((char const *)"Failed to compute connected components!")));

    /* "_ext/cython_igraph.pyx":182
 *     if igraph_connected_components(&graph, NULL, &csize, &comp_size, IGRAPH_WEAK) != 0:
 *         printf("Failed to compute connected components!")
 *         igraph_vector_destroy(&weights)             # <<<<<<<<<<<<<<
 *         igraph_vector_int_destroy(&csize)
...
static double __pyx_f_4_ext_13cython_igraph_igraph_betweenness(__Pyx_memviewslice __pyx_v_adj_matrix, int *__pyx_v_k_set, int *__pyx_v_notk_set, int __pyx_v_k) {
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  double __pyx_r;
  igraph_int_t __pyx_t_1;
  igraph_int_t __pyx_t_2;
  Py_ssize_t __pyx_t_3;
  Py_ssize_t __pyx_t_4;
  igraph_int_t __pyx_t_5;
  igraph_int_t __pyx_t_6;
  int __pyx_t_7;
  int __pyx_t_8;
 ...
 *     for i from 0 <= i < ig_n:
*/
  (void)(igraph_matrix_init((&__pyx_v_ig_adj_matrix), __pyx_v_ig_n, __pyx_v_ig_n));

  /* "_ext/cython_igraph.pyx":220
 *     igraph_matrix_init(&ig_adj_matrix, ig_n, ig_n)
 * 
 *     for i from 0 <= i < ig_n:             # <<<<<<<<<<<<<<
 *         for j from 0 <= j < ig_n:
 *             igraph_matrix_set(&ig_adj_matrix, i, j, adj_matrix[i, j])
*/
  __pyx_t_1 = __pyx_v_ig_n;
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_1; __pyx_v_i++) {

    /* "_ext/cython_igraph.pyx":221
 * 
 *     for i from 0 <= i < ig_n:
 *         for j from 0 <= j < ig_n:             # <<<<<<<<<<<<<<
 *             igraph_matrix_set(&ig_adj_matrix, i, j, adj_matrix[i, j])
...
*/
      __pyx_t_3 = __pyx_v_i;
      __pyx_t_4 = __pyx_v_j;
      igraph_matrix_set((&__pyx_v_ig_adj_matrix), __pyx_v_i, __pyx_v_j, (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_adj_matrix.data + __pyx_t_3 * __pyx_v_adj_matrix.strides[0]) ) + __pyx_t_4 * __pyx_v_adj_matrix.strides[1]) ))));
    }
  }

  /* "_ext/cython_igraph.pyx":224
 *             igraph_matrix_set(&ig_adj_matrix, i, j, adj_matrix[i, j])
 * 
 *     igraph_vector_init(&weights, 0)             # <<<<<<<<<<<<<<
 * 
...
*/
  (void)(igraph_vector_init((&__pyx_v_weights), 0));
...
*/
  (void)(igraph_weighted_adjacency((&__pyx_v_graph), (&__pyx_v_ig_adj_matrix), IGRAPH_ADJ_UNDIRECTED, (&__pyx_v_weights), IGRAPH_LOOPS_ONCE));

  /* "_ext/cython_igraph.pyx":228
 *     igraph_weighted_adjacency(&graph, &ig_adj_matrix, IGRAPH_ADJ_UNDIRECTED, &weights, IGRAPH_LOOPS_ONCE)
 * 
 *     igraph_vector_int_list_init(&vertices, 0);             # <<<<<<<<<<<<<<
...
*/
  __pyx_t_1 = ((__pyx_v_ig_n - __pyx_v_k) - 1);
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_1; __pyx_v_i++) {

    /* "_ext/cython_igraph.pyx":233
 *     for i from 0 <= i < (ig_n - k - 1):  # -1 because last node has no remaining destinations
 *         # Create vector selector starting from position i+1
 *         igraph_vector_int_init(&subset, (ig_n - k - i - 1))             # <<<<<<<<<<<<<<
 * 
 ...
 * 
*/
    __pyx_t_2 = (((__pyx_v_ig_n - __pyx_v_k) - __pyx_v_i) - 1);
    for (__pyx_v_j = 0; __pyx_v_j < __pyx_t_2; __pyx_v_j++) {

      /* "_ext/cython_igraph.pyx":237
 *         # Copy remaining vertices
 *         for j from 0 <= j < (ig_n - k - i - 1):
 *             igraph_vector_int_set(&subset, j, notk_set[i + 1 + j])             # <<<<<<<<<<<<<<
 * 
 ...
 *             geodesic_group = 0.
*/
    __pyx_t_2 = igraph_vector_int_size((&__pyx_v_subset));
    for (__pyx_v_j = 0; __pyx_v_j < __pyx_t_2; __pyx_v_j++) {

      /* "_ext/cython_igraph.pyx":248
 *         for j from 0 <= j < igraph_vector_int_size(&subset):
 * 
 *             geodesic_group = 0.             # <<<<<<<<<<<<<<
 ...
 *                 tot_geodesics += 1
*/
      __pyx_t_5 = igraph_vector_int_get((&__pyx_v_nrgeo), __pyx_v_node);
      for (__pyx_v_w = 0; __pyx_v_w < __pyx_t_5; __pyx_v_w++) {
 ...
 *                     for y from 0 <= y < k:
*/
        __pyx_t_6 = igraph_vector_int_size(__pyx_v_geodesic_ptr);
        for (__pyx_v_z = 0; __pyx_v_z < __pyx_t_6; __pyx_v_z++) {
 ...
 *                             break
*/
            __pyx_t_8 = (igraph_vector_int_get(__pyx_v_geodesic_ptr, __pyx_v_z) == (__pyx_v_k_set[__pyx_v_y]));
            if (__pyx_t_8) {

              /* "_ext/cython_igraph.pyx":261
 *                     for y from 0 <= y < k:
 *                         if igraph_vector_int_get(geodesic_ptr, z) == k_set[y]:
 *                             geodesic_group += 1.             # <<<<<<<<<<<<<<
 *                             break
...
*/
      __pyx_v_betweenness = (__pyx_v_betweenness + (__pyx_v_geodesic_group / ((double)igraph_vector_int_get((&__pyx_v_nrgeo), __pyx_v_node))));
    }

    /* "_ext/cython_igraph.pyx":266
 *             betweenness += geodesic_group / igraph_vector_int_get(&nrgeo, node)
 * 
 *         igraph_vector_int_destroy(&subset)             # <<<<<<<<<<<<<<
 * 
...
static int __Pyx_modinit_function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (__Pyx_ExportFunction("igraph_dijkstra", (void (*)(void))__pyx_f_4_ext_13cython_igraph_igraph_dijkstra, "int (__Pyx_memviewslice, double *, int *, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("igraph_components", (void (*)(void))__pyx_f_4_ext_13cython_igraph_igraph_components, "int (__Pyx_memviewslice, long *, int *, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("igraph_betweenness", (void (*)(void))__pyx_f_4_ext_13cython_igraph_igraph_betweenness, "double (__Pyx_memviewslice, int *, int *, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __pyx_pymod_exec_cython_igraph(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cython_igraph},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_cython_igraph(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cython_igraph(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cython_igraph(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cython_igraph' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "cython_igraph" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_cython_igraph", 0);

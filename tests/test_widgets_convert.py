...
class WidgetTestConvert(unittest.TestCase):
    def setUp(self):
        ...
        self.graph = PyntacleImporter.AdjacencyMatrix(file=os.path.join(current_dir,
                                                                        'tests/test_sets/input/figure_8.txt'),
                                                      sep='\t', header=True)

    def test_convert_sif(self):
        sys.stdout.write("Testing sif conversion\n")
        fileout = os.path.join(current_dir, 'tests/test_sets/tmp/test.sif')
        expected = os.path.join(current_dir, 'tests/test_sets/output/convert/figure8.sif')
    ...
    def test_convert_egl(self):
        ...
        fileout = os.path.join(current_dir, 'tests/test_sets/tmp/test.egl')
        expected = os.path.join(current_dir, 'tests/test_sets/output/convert/figure8.egl')
    ...
    def test_convert_bin(self):
        ...
        fileout = os.path.join(current_dir, 'tests/test_sets/tmp/test.graph')
        expected = os.path.join(current_dir, 'tests/test_sets/output/convert/figure8.graph')
    ...
    def test_convert_dot(self):
        ...
        fileout = os.path.join(current_dir, 'tests/test_sets/tmp/test.dot')
        expected = os.path.join(current_dir, 'tests/test_sets/output/convert/figure8.dot')
    ...
    def test_convert_adjm(self):
        ...
        fileout = os.path.join(current_dir, 'tests/test_sets/tmp/test.adjm')
        expected = os.path.join(current_dir, 'tests/test_sets/input/figure_8.txt')
    ...
    def test_egl_to_sif(self):
        ...
        filein = os.path.join(current_dir, 'tests/test_sets/input/figure_8.egl')
        fileout = os.path.join(current_dir, 'tests/test_sets/tmp/test_egltosif.sif')
        expected = os.path.join(current_dir, 'tests/test_sets/output/convert/figure8_egltosif.sif')
    ...
    def test_sif_to_egl(self):
        ...
        filein = os.path.join(current_dir, 'tests/test_sets/input/figure_8.sif')
        fileout = os.path.join(current_dir, 'tests/test_sets/tmp/test_siftoegl.egl')
        expected = os.path.join(current_dir, 'tests/test_sets/output/convert/figure8_siftoegl.egl')

...
Due to some missing dependencies, at the moment we are forced to revert to Python v.3.5. Open a cmd terminal window or - better - an |AnacondaPrompt|, and type:

.. |AnacondaPrompt| raw:: html

   <a href="https://chrisconlan.com/wp-content/uploads/2017/05/anaconda_prompt.png"  target="_blank">Anaconda prompt</a>

:: 

  conda create -y -n name_of_my_env python=3.5
...
Then, we need to download and install the Cairo library:
